...
<div className=' grid  items-start mx-auto w-full  xs:w-1/2 md:w-full px-4  '>
  <div><Image src='/icons/location.png' alt='sisterlocks salon in nairobi' width={40} height={40} className='flex-shrink-0 border md:w-[47px] md:h-[47px] mx-auto ' /></div>
  <div className='grid '>
...
<div className='grid  items-start mx-auto w-full  xs:w-1/2 md:w-full px-4  '>
  <div><Image src='/icons/support.png' alt='sisterlocks salon in nairobi' width={40} height={40} className='flex-shrink-0 border md:w-[47px] md:h-[47px] mx-auto ' /></div>
  <div className='grid '>
...
<div className='grid xs:flex  w-full md:w-1/2 py-2.5 justify-center xs:justify-between gap-2 xs:gap-0'>
<div className=' grid  items-start mx-auto w-full  xs:w-1/2 md:w-full px-4  '>
  <div><Image src='/icons/followup.png' alt='sisterlocks salon in nairobi' width={40} height={40} className='flex-shrink-0 border md:w-[47px] md:h-[47px] mx-auto ' /></div>
  <div className='grid '>
...
<div className=' grid  items-start mx-auto w-full  xs:w-1/2 md:w-full px-4 '>
  <div><Image src='/icons/essentialoils.png' alt='sisterlocks salon in nairobi' width={40} height={40} className='flex-shrink-0 border md:w-[47px] md:h-[47px] mx-auto ' /></div>
  <div className='grid '>
