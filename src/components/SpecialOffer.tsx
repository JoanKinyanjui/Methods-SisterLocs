...
function SpecialOffer() {
  ...
  return (
      <div className='relative w-full  font-[Inter]'>
        <div className="bg-fixed bg-left-bottom bg-cover  h-full w-full grid items-center justify-center py-5 md:py-10" style={{backgroundImage:"url('/images/background2.jpg')"}} >
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-brown_1 bg-opacity-10  "></div>
          <div className='grid md:flex md:items-center gap-2 md:gap-4 px-4 w-[100%] md:w-[80%] xl:w-[70%] mx-auto z-40 '>
            <div><Image src='/images/background1.png' alt='' width={150} height={150} className='sm:w-[450px] sm:h-auto md:w-[600px] md:h-auto rounded-full mx-auto md:mx-0' /></div>
           <div>
