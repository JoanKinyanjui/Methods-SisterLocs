...
<p>We are Specialized in :</p>
 ...
 <Button />
  ...
  <div className='w-full h-[150px] lg:h-[250px] flex justify-between gap-1'>
   <div className='w-[50%]  '>
      <Image src='/images/delivery.jpg' height={300} width={300} alt='sisterlocks in nairobi' className=' w-[100%] h-[100%] rounded-[5px]'/>
    </div>
   ...
   <div className='w-full h-[150px] lg:h-[250px] flex justify-between gap-1'>
   <div className='w-[50%]  '>
      <Image src='/images/group.jpg' height={300} width={300} alt='sisterlocks in nairobi' className=' w-[100%] h-[100%] rounded-[5px]'/>
    </div>
    <div className='w-[50%]'>
    <Image src='/images/delivery2.jpg' height={300} width={300} alt='sisterlocks in nairobi' className=' w-[100%] h-[100%] rounded-[5px]'/>
    </div>
   </div>
  </div>
