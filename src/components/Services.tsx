...
{services.map((item)=>(
  ...
  <div className='absolute bottom-0 px-2 py-1'>
   <p className='text-[13px] md:text-[15px] font-medium text-white '>{item.title}</p>
