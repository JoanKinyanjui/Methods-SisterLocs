...
function Nav() {
  ...
  return (
   ...
   <div className={`bg-gradient-to-r from-brown_1 via-[#FFAF00] to-brown_1 text-[18px] md:text-[24px] font-[700] font-frank italic ${styles.TextGradient}`}>Methods Sisterlocks</div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" fill="none" stroke="url(#gradient2)" stroke-width="1"/>
   ...
   <ul className={`gap-2 grid justify-start  `}>
     <li className=" text-[14px]  font-[500]  hover:text-black_1" ><a href='#About'>About</a></li>
      <li  className="text-[14px]  font-[500]  hover:text-black_1 "  ><a href='#Services'>Services</a></li>
      <li  className="text-[14px]  font-[500]  hover:text-black_1 "><a  href='#Team'>Team</a></li>
    <li  className="text-[14px]  font-[500]  hover:text-black_1 " ><a href='#Reviews'>Reviews</a></li>
    </ul> 
   </div> 
</div>  
