...
<div className='grid justify-center float-animation '>
  ...
  <Image src={active?.image} alt='team' width={200} height={200} className=' rounded-t-md bg-gray_2 md:w-[300px] lg:w-[260px] h-[200px] md:h-[250px] lg:h-[300px] object-cover'/>
