...
function Hero() {
  return (
    ...
    <div className="absolute inset-0 bg-black_1 opacity-30"></div>

    {/* Content */}
    <div className="relative z-10 flex items-center justify-between  top-[70px] h-[40vh] sm:h-[50vh] lg:h-[60vh] w-11/12 sm:w-10/12  md:w-[80%]  mx-auto">
