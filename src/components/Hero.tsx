...
function Hero() {
  ...
  return (
 <div className='relative  w-full  mt-[70px] flex justify-center  bg-left-bottom bg-cover' style={{backgroundImage:"url('/images/background3.jpg')"}}>
 {/* Overlay */}
 <div className="absolute w-full h-full bg-black_1 bg-opacity-40 "></div>
  ...
  <div className='flex mx-auto md:mr-0 w-full md:w-1/2 lg:w-[50%] justify-center md:justify-end'>
    <Image src='/images/background0.png' alt='' width={300} height={300} className='rounded-full sm:w-[400px] sm:h-[400px] md:w-[100%] xl:w-[90%] md:h-auto flex-shrink-0 flex-grow-0'/>
  </div>
